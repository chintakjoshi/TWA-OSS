  ...
  return (
    <div className="flex flex-col gap-4 border-b border-[#eadfce] px-6 py-5 sm:flex-row sm:items-center sm:justify-between">
      <div className="space-y-1">
        <h2 className="jobseeker-display text-[1.15rem] font-semibold text-slate-950">
          {title}
        </h2>
...
export function EmptyPanel({
  ...
  return (
    <div className="rounded-2xl border border-dashed border-[#d8cab2] bg-[#fcfaf6] px-6 py-10 text-center">
      <h3 className="jobseeker-display text-xl font-semibold text-slate-950">
        {title}
      </h3>
...
export function LoadingPanel({
  title,
  message = 'Pulling the latest jobseeker portal data.',
}: {
  title: string
  message?: string
}) {
...
export function ErrorPanel({
  ...
  return (
    <PortalPanel className="border-[#f0c7c4] bg-[#fff8f7] px-6 py-6">
      <h3 className="jobseeker-display text-xl font-semibold text-[#8f2621]">
        {title}
      </h3>
    ...
    <PortalPanel className="relative min-h-[146px] overflow-hidden">
      ...
      <div className="flex items-start justify-between gap-4 px-6 py-5">
        <div className="space-y-4">
          ...
          <div className="space-y-1">
            <p className="jobseeker-display text-4xl leading-none font-semibold text-slate-950">
              {value}
            </p>
    ...
    >
      ...
      >
        <div className="border-b border-[#eadfce] px-6 py-5">
          <h2 className="jobseeker-display text-[1.6rem] font-semibold text-slate-950">
            {title}
          </h2>
        </div>
