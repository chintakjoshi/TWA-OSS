      ...
      <main className="page-frame stack-md">
        ...
        >
          <div className="stack-md">
                ...
                <CardBody className="stack-md">
                  ...
                  >
                    <div className="stack-sm">
                      ...
                      <p className="card-copy">
                        authSDK signs you in first. TWA bootstrap is the second
                        step that creates your local jobseeker account.
                      </p>
                    </div>
                  ...
                  <div className="inline-actions">
                    <Button
                      onClick={() => {
                        void auth.bootstrapRole({ role: 'jobseeker' })
                      }}
                    >
                ...
                <CardBody className="stack-md">
                  ...
                  >
                    <div className="stack-sm">
                      ...
                      <p className="card-copy">
                        Complete your profile first, then move into the job
                        board and application tracker.
                      </p>
                    </div>
                    <Badge
                      tone={
                        auth.authMe.profile_complete ? 'success' : 'warning'
                      }
                    >
            ...
            {auth.authMe?.app_user?.app_role &&
            auth.authMe.app_user.app_role !== 'jobseeker' ? (
              <Card strong>
                <CardBody className="stack-md">
                  <p className="eyebrow">Wrong portal</p>
                  <h2 className="card-title">
                    This account is tied to a different TWA role.
                  </h2>
                  <p className="card-copy">
                    Use the matching portal for {auth.authMe.app_user.app_role}{' '}
                    accounts, or contact staff if the role is wrong.
                  </p>
                </CardBody>
              </Card>
            ) : null}
