          ...
          <Card strong>
            <CardBody className="stack-md">
              ...
              >
                <div className="stack-sm">
                  ...
                  <h2 className="card-title">
                    Staff review status drives what happens next.
                  </h2>
                  <p className="portal-copy">
                    This dashboard is the employer home base for profile status,
                    listing submission readiness, and applicants visibility.
                  </p>
                </div>
              ...
              {reviewStatus === 'pending' ? (
                <Alert tone="warning">
                  <p>
                    Your employer account is still pending review. You can
                    complete your profile now, but listing submission will stay
                    locked until staff approves the account.
                  </p>
                </Alert>
              ) : null}
              {reviewStatus === 'rejected' ? (
                <Alert tone="danger">
                  <p>
                    Your employer account was rejected. Review the staff note
                    and update your profile before asking for reassessment.
                  </p>
                </Alert>
              ) : null}
              {reviewStatus === 'approved' ? (
                <Alert tone="success">
                  <p>
                    Your employer account is approved. You can now submit
                    listings and review applicants when sharing is enabled.
                  </p>
                </Alert>
              ) : null}
              {profile?.review_note ? (
              ...
              <div className="dashboard-grid">
                <Card>
                  <CardBody className="stack-sm">
                    ...
                    <h3 className="dashboard-stat">
                      {profile?.org_name ?? 'Employer profile'}
                    </h3>
                    <p className="card-copy">
                      Keep the profile current so staff can reassess it whenever
                      needed.
                    </p>
                  </CardBody>
                </Card>
                <Card>
                  <CardBody className="stack-sm">
                    ...
                    <p className="card-copy">
                      Approved, pending, and rejected listings all stay visible
                      here for tracking.
                    </p>
                  </CardBody>
                </Card>
