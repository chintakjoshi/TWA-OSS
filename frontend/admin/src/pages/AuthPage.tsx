            ...
            {!auth.authMe?.app_user ? (
              <Card strong>
                <CardBody className="stack-md">
                  ...
                  <p className="card-copy">If you can authenticate through authSDK but still have no local TWA staff record, the team needs to provision the account.</p>
                </CardBody>
              </Card>
            ) : null}
                ...
                <CardBody className="stack-md">
                  <div className="cluster" style={{ justifyContent: 'space-between', alignItems: 'center' }}>
                    <div className="stack-sm">
                      ...
                      <p className="card-copy">The operational workspace is ready behind this route guard.</p>
                    </div>
