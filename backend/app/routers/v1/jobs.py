...
def list_jobs(
    ...
    transit_required: str | None = Query(default=None),
    ...
    return list_visible_jobs_for_jobseeker(
        session,
        jobseeker=jobseeker,
...
def get_job_detail(
    ...
    return get_job_detail_for_jobseeker(
        session, jobseeker=jobseeker, job_listing_id=job_id
    )
